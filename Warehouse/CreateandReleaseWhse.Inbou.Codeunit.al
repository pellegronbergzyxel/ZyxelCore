    ...
    begin
        begin
            ...
            if recAutoSetup.WhseCreateAndReleaseInbound then begin
                ...
                recWhseInbHead.SetRange(recWhseInbHead."Automatic Created", true);
                    ...
                    repeat
                        ...
                        case recWhseInbHead."Order Type" of
                            ...
                            recWhseInbHead."order type"::"Purchase Invoice": //12-09-2025 BK #527409
                                if recAutoSetup."Release EMEA Whse. Inbound" then
                                    if (recVend."SBU Company" in [recVend."sbu company"::"ZCom EMEA", recVend."sbu company"::"ZNet EMEA"]) then
                                        Codeunit.Run(Codeunit::"Release Warehouse Inbound", recWhseInbHead);
                        end;
