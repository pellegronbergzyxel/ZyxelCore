pageextension 50167 PaymentJournalZX extends "Payment Journal"
{
    layout
    {
        addafter("Account No.")
        {
            field("Vendor Full Name"; Rec."Vendor Full Name")
            {
        ...
        addafter("Void &All Checks")
        {
            action("Print Remittance Advice")
            {
                ...
                begin
                    ...
                    //15-51643 Rework REPORT.RUN(REPORT::"Remittance Advice - Journal UK",TRUE,FALSE,GenJnlLine);
                end;
            }
        }
    }
    ...
    begin
        //15-51643 Table 356 not exist. rework
        /*
