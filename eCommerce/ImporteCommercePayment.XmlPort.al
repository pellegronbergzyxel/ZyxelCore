xmlport 50016 "Import eCommerce Payment"
{
            ...
            tableelement(Integer; Integer)
            {
                ...
                begin
                    if recAmzPayBatch."Transaction Summary" = '' then begin
                        ...
                        recAmzPayBatch."Market Place ID" := MarketPlaceID;
    ...
    requestpage
    {
        ...
        layout
        {
            area(content)
            {
                ...
                {
                    Caption = 'Options';
                    field(MarketPlaceID; MarketPlaceID)
                    {
                        ApplicationArea = Basic, Suite;
                        Caption = 'Market Place ID';
                        TableRelation = "eCommerce Market Place" where(Active = const(true));
                    }
    ...
    var
        ...
        MarketPlaceID: Code[20];
        lText003: Label 'Market Place ID must be filled.';
    ...
    begin
        ...
        case UpperCase(DelChr(ProductDetail, '=', ' :')) of
            ...
            UpperCase(DelChr('Vine enrolment fee', '=', ' ')):
                gPaymentDetail := recAmzPayJnl."payment detail"::"Vine enrolment fee";
            '':
                gPaymentDetail := recAmzPayJnl."payment detail"::Blank;
            else
                if OrderID = '---' then
