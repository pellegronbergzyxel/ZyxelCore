Page 50246 "eCommerce Order FactBox2"
{
    ...
    layout
    {
        area(content)
        {
            group(Control8)
            {
                ...
                group(AmountDetail)
                {
                    Caption = 'Details Excl. VAT';
                    Visible = AmountDetailVisible;
                    field("Item Excl. VAT"; Rec."Item Excl. VAT")
                    {
                        ApplicationArea = Basic, Suite;
                        Caption = 'Item';
                    }
                    field("Shipping Excl. VAT"; Rec."Shipping Excl. VAT")
                    {
                        ApplicationArea = Basic, Suite;
                        Caption = 'Shipping';
                        Visible = ShippingExclVatVisible;
                    }
                    field("Promotion Excl. VAT"; Rec."Promotion Excl. VAT")
                    {
                        ApplicationArea = Basic, Suite;
                        Caption = 'Promotion';
                        Visible = PromoExclVatVisible;
                    }
                }
                group(Total)
                {
