Page 50209 "HR Activities"
{
    // 001. 25-01-18 ZY-LD 2018011910000116 - Calculate next birthday.
    // 002. 22-05-18 ZT-LD 2018050910000191 - New field.
    // 003. 19-09-18 ZY-LD 2018091910000111 - Update "Active Employee".
    // 004. 15-10-18 ZY-LD 2018101510000026 - New fields.
    // 005. 26-06-19 ZY-LD 2019062410000088 - Captions is adjusted.
    // 006. 12-11-19 ZY-LD 2019111110000048 - Headcount Control.
    ...
    layout
    {
        area(content)
        {
            ...
            cuegroup(Employees)
            {
                ...
                field("Headcount Controllers"; Rec."Headcount Controllers")
                {
                    ApplicationArea = Basic, Suite;
    ...
    begin
        ...
        Rec.SetFilter(Rec."Headcount Countrol Filter", '010118..CM|%1', 0D);  // 12-11-19 ZY-LD 006
    end;
    ...
    var
        ...
        Text026: label 'Headcount Controllers';
        Text027: label 'Belgium';
