    ...
    dataset
    {
        dataitem(Item; Item)
        {
            ...
            begin
                ...
                CalcInvtValCheck.SetParameters(PostingDate, CalculatePer, ByLocation, ByVariant, ShowDialog, false); //UpgradeReady
        ...
        case CalcBase of
            ...
            CalcBase::"Last Direct Unit Cost":
                if SKU.Get(ItemJnlLine."Location Code", ItemJnlLine."Item No.", ItemJnlLine."Variant Code") then
                    ItemJnlLine.Validate(ItemJnlLine."Unit Cost (Revalued)", SKU."Last Direct Cost")
                else begin
