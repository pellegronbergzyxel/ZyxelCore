Report 50071 "WEEE Invoice Excel Export"
{
    ...
    Caption = 'WEEE Invoice based Excel Export';
    ProcessingOnly = true;
    UsageCategory = Lists;
    ...
    dataset
    {
        dataitem("Item Ledger Entry"; "Item Ledger Entry")
        {
            ...
            begin
                ShipToCountries := "Item Ledger Entry".GetFilter("Country/Region Code");
                "Item Ledger Entry".SetRange("Country/Region Code");
                "Item Ledger Entry".SetFilter("Location Code", '<>%1', 'PP*');
    ...
    begin
        ...
        SI.UseOfReport(3, 50071, 3);  // 14-10-20 ZY-LD 000
    end;
    ...
    var
        recSalesShipHead: Record "Sales Invoice Header";
    ...
    begin
        begin
            ...
            if pItemLedgerEntry."Entry Type" = pItemLedgerEntry."entry type"::Sale then begin
                if ((pItemLedgerEntry."Document Type" = pItemLedgerEntry."document type"::"Sales Invoice") or
