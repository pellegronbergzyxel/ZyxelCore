Page 50013 "Accounting Manager ZYXEL RTC"
{
    Caption = 'Role Center';
    PageType = RoleCenter;
    ...
    layout
    {
        area(rolecenter)
        {
            group(Control1900724808)
            {
                ...
                part(Control130; "Sales Revenue Activities")
                {
    ...
    actions
    {
        area(reporting)
        {
            ...
            action("IC Reconcilation")
            {
                ApplicationArea = Basic, Suite;
                Caption = 'IC Reconcilation';
                Image = "Report";
                RunObject = Report "IC Reconciliation";
            }
        }
        area(embedding)
        {
            ...
            action(Eurocard)
            {
                ...
                Image = Vendor;
                RunObject = Page "Vendor List";
                RunPageLink = "Vendor Posting Group" = const('EUROCARD');
            }
            action(Employee)
            {
                ApplicationArea = Basic, Suite;
                ...
                Image = Vendor;
                RunObject = Page "Vendor List";
                RunPageLink = "Vendor Posting Group" = const('PERSONNEL');
            }
            ...
            action("Travel Expense")
            {
                ApplicationArea = Basic, Suite;
                Caption = 'Travel Expense';
                RunObject = Page "Travel Expense List";
            }
        }
        area(sections)
        {
            group(Journals)
            {
                ...
                action("IC Reconciliation Journals")
                {
                    ApplicationArea = Basic, Suite;
                    Caption = 'IC Reconciliation Journals';
                    RunObject = Page "IC Reconciliation Templates";
                }
            }
            group("Fixed Assets")
            {
        ...
        area(processing)
        {
            ...
            group("IC Reconciliation")
            {
                ...
                action("IC Reconciliation Templates")
                {
                    ApplicationArea = Basic, Suite;
