XmlPort 50004 "IC Outbox Imp/Exp ZX"
{
    ...
    schema
    {
        textelement(ICTransactions)
        {
            tableelement(icoutboxtrans; "IC Outbox Transaction")
            {
                ...
                fieldattribute(SourceLineNo; ICOutboxTrans."IC Account Type")
                {
                }
                ...
                textelement(ICOutBoxSalesHeaders)
                {
                    ...
                    tableelement(icoutboxsaleshdr; "IC Outbox Sales Header")
                    {
                        ...
                        fieldattribute(ShipToPostCode; ICOutBoxSalesHdr."Ship-to Post Code")
                        {
                        }
                        ...
                        textelement(ICOutBoxSalesLines)
                        {
                            tableelement(icoutboxsalesline; "IC Outbox Sales Line")
                            {
                                ...
                                fieldelement(Location; ICOutBoxSalesLine."Location Code")
                                {
                                }
                                fieldelement(ExternalDocumentNo; ICOutBoxSalesLine."External Document No.")
                                {
                                }
                                fieldelement(LineDiscount; ICOutBoxSalesLine."Line Discount %")
                                {
                                }
                                fieldelement(ReturnReasonCode; ICOutBoxSalesLine."Return Reason Code")
                                {
                                }
                                fieldelement(HideLine; ICOutBoxSalesLine."Hide Line")
                                {
                                }
                ...
                textelement(ICOutBoxPurchHeaders)
                {
                    ...
                    tableelement(icoutboxpurchhdr; "IC Outbox Purchase Header")
                    {
                        ...
                        fieldelement(ShiptoPostCode; ICOutBoxPurchHdr."Ship-to Post Code")
                        {
                        }
                        ...
                        textelement(ICOutBoxPurchLines)
                        {
                            tableelement(icoutboxpurchline; "IC Outbox Purchase Line")
                            {
                                ...
                                fieldattribute(ReturnReasonCode; ICOutBoxPurchLine."Return Reason Code")
                                {
                                }
                                fieldattribute("Gen.ProdPostingGroup"; ICOutBoxPurchLine."Document Type")
                                {
                                }
                                fieldattribute(LineDiscount; ICOutBoxPurchLine."Line Discount %")
                                {
                                }
