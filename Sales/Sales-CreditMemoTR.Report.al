Report 50067 "Sales - Credit Memo TR"
{
    ...
    // 003. 16-02-18 ZY-LD 2018021410000151 - In Turkey we will not show discount.
    ...
    DefaultLayout = RDLC;
    RDLCLayout = './Layouts/Sales - Credit Memo TR.rdlc';

    Caption = 'Sales - Credit Memo TR';
                ...
                dataitem(PageLoop; "Integer")
                {
                    ...
                    dataitem("Sales Cr.Memo Line"; "Sales Cr.Memo Line")
                    {
                        ...
                        begin
                            ...
                            //>> 16-02-18 ZY-LD 003
                            if "Sales Cr.Memo Line".Quantity <> 0 then
                                UnitPrice := ROUND("Sales Cr.Memo Line"."Line Amount" / "Sales Cr.Memo Line".Quantity, 0.0001)
                            else
                                UnitPrice := 0;
                            //<< 16-02-18 ZY-LD 003
                            ...
                            if "Sales Cr.Memo Line".Type in ["Sales Cr.Memo Line".Type::"G/L Account", "Sales Cr.Memo Line".Type::Item] then
                                ReportEvent.GetEUArticle(
                                  ...
                                  "Sales Cr.Memo Header"."EU 3-Party Trade",  // 10-06-22 ZY-LD 007
                                  ArticleText);
