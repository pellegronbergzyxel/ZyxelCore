Table 50019 "Posted Item Charge (Sales-Inv)"
{
    Caption = 'Posted Item Charge Assignment (Invoice)';
    PasteIsValid = false;
    ...
    fields
    {
        ...
        field(13; "Applies-to Doc. No."; Code[20])
        {
            ...
            TableRelation = if ("Applies-to Doc. Type" = const(Order)) "Sales Invoice Header"."No."
            else
            if ("Applies-to Doc. Type" = const(Invoice)) "Sales Invoice Header"."No.";
        }
        field(14; "Applies-to Doc. Line No."; Integer)
        {
            Caption = 'Applies-to Doc. Line No.';
            TableRelation = if ("Applies-to Doc. Type" = const(Order)) "Sales Invoice Line"."Line No." where("Document No." = field("Applies-to Doc. No."))
            else
            if ("Applies-to Doc. Type" = const(Invoice)) "Sales Invoice Line"."Line No." where("Document No." = field("Applies-to Doc. No."));
        }
