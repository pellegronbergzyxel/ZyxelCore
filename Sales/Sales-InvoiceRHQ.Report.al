Report 50001 "Sales - Invoice RHQ"
{
    ...
    // 004. 05-03-20 ZY-LD 2020030410000109 - Reverse Charge.
    // 005. 09-07-20 ZY-LD P0455 - Shipment Method caption is changed to Incoterms, and "Ship-to City is added".
    // 006. 11-12-20 ZY-LD 2020121010000091 - Incoterms city can be different.
    // 007. 28-01-21 ZY-LD P0559 - EORI No.
    // 008. 29-01-21 ZY-LD 2021012910000163 - Sell-to VAT Reg. No. has moved from "Sell-to" to "Ship-to" on the layout.
    // 009. 08-02-21 ZY-LD 2021011510000162 - Text has moved to the lines, and is selected from a table.
    // 010. 09-08-21 ZY-LD 2021070210000087 - Position on External document No.
    // 011. 31-05-22 ZY-LD 2022053010000106 - "External Document No." and "Tarriff No." is only shown on items.
    // 012. 10-06-22 ZY-LD 2022061010000099 - "EU 3-Party Trade".
    DefaultLayout = RDLC;
    RDLCLayout = './Layouts/Sales - Invoice RHQ.rdlc';
        ...
        dataitem("Sales Invoice Header"; "Sales Invoice Header")
        {
            ...
            dataitem(CopyLoop; "Integer")
            {
                ...
                dataitem(PageLoop; "Integer")
                {
                    ...
                    column(EoriNoCaptionCust; EoriNoCaptionCust)
                    {
                    }
                    column(EoriNoCaptionComp; EoriNoCaptionComp)
                    {
                    }
                    ...
                    dataitem("Sales Invoice Line"; "Sales Invoice Line")
                    {
                        ...
                        column(CressRef_SalesInvLine; "Sales Invoice Line"."Item Reference No.")
                        {
                        }
                        ...
                        begin
                            ...
                            //>> 31-10-17 ZY-LD 001
                            if ShipToCountryRegion."Show Country of Origin on Inv." then
                                if (recItem."Country/Region of Origin Code" <> '') and
                                    ItemCountryRegion.Get(recItem."Country/Region of Origin Code")
                                then
                                    TarrifCode := CopyStr(TarrifCode + ', Coo: ' + ItemCountryRegion.Name, 1, MaxStrLen("Sales Invoice Line".Description));
                            //<< 31-10-17 ZY-LD 001
                            ...
                            if "Sales Invoice Line".Type in ["Sales Invoice Line".Type::"G/L Account", "Sales Invoice Line".Type::Item] then
                                ReportEvent.GetEUArticle(
                                  ...
                                  "Sales Invoice Header"."EU 3-Party Trade",  // 10-06-22 ZY-LD 012
                                  ArticleText);
                            //<< 08-02-21 ZY-LD 009
            ...
            begin
                        ...
                        case ShipmentMethod."Read Incoterms City From" of
                            ShipmentMethod."read incoterms city from"::"Ship-to City":
                                begin
                                    ...
                                    ShipmentMethod.Description := StrSubstNo('%1 %2', "Sales Invoice Header"."Shipment Method Code", "Sales Invoice Header"."Ship-to City");  // 09-07-20 ZY-LD 005
                                end;
                ...
                EoriNoCustomer := '';
                EoriNoCompany := '';
                if sellcust."EORI No." <> '' then begin
                    EoriNoCaptionCust := EoriNoCaptionLbl;
                    EoriNoCustomer := sellcust."EORI No.";
                end;
                if CompanyInfo."EORI No." <> '' then begin
                    EoriNoCaptionComp := EoriNoCaptionLbl;
                ...
                //>> 08-02-21 ZY-LD 009
                /*//>> 05-03-20 ZY-LD 004
                IF "Sell-to Customer No." IN ['10273','10285'] THEN
                  ArticleText := Text50004
                ELSE
                  ArticleText := Text50003;
                //<< 05-03-20 ZY-LD 004*/
    ...
    var
        ...
        ArticleText: Text;
        Text50003: label 'Reverse charge, article 28c A in Directive 2006/112/EF artikel 138.';
        Text50004: label 'Reverse charge, article 12 paragraph 3 in Directive 2006/112/EF article138.';
        EoriNoCaptionCust: Text[10];
        EoriNoCaptionComp: Text[10];
    ...
    begin
        //>> 11-02-19 ZY-LD 002
        if not BillToCountryRegion.Get("Sales Invoice Header"."Bill-to Country/Region Code") then
            exit;
