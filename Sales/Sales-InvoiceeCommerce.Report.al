Report 50079 "Sales - Invoice eCommerce"
{
    ...
    // 013. 09-08-21 ZY-LD 2021070210000087 - Position on External document No.
    // 014. 05-11-21 ZY-LD 000 - Ship-to VAT.
    // 015. 31-05-22 ZY-LD 2022053010000106 - "External Document No." and "Tarriff No." is only shown on items.
    // 019. 10-06-22 ZY-LD 2022061010000099 - "EU 3-Party Trade".
    DefaultLayout = RDLC;
    RDLCLayout = './Layouts/Sales - Invoice eCommerce.rdlc';
    ...
    dataset
    {
        dataitem("Sales Invoice Header"; "Sales Invoice Header")
        {
                    ...
                    dataitem("Sales Invoice Line"; "Sales Invoice Line")
                    {
                        ...
                        begin
                            ...
                            if ("Sales Invoice Line".Type = "Sales Invoice Line".Type::Item) and ("Sales Invoice Line"."No." <> '') then begin
                                ...
                                TarrifCode := '';
                                TarrifCode := StrSubstNo('Tariff: %1', recItem."Tariff No.");  // 12-08-19 ZY-LD 004

                                //>> 31-10-17 ZY-LD 001
                                if (SellToCountryRegion."Show Country of Origin on Inv.") and
                                   (recItem."Country/Region of Origin Code" <> '')
                                  then
                                    TarrifCode := TarrifCode + StrSubstNo('; Coo: %1', recItem."Country/Region of Origin Code");
                                //<< 31-10-17 ZY-LD 001

                                //>> 12-08-19 ZY-LD 004
                                if (SellToCountryRegion."Show Gross Weight on Inv.") and
                                   (recItem."Gross Weight" <> 0)
                                then
                                    TarrifCode := TarrifCode + StrSubstNo('; GW: %1', recItem."Gross Weight");
                                //<< 12-08-19 ZY-LD 004

                                //>> 27-05-21 ZY-LD 013
                                if (SellToCountryRegion."Show Net Weight on Inv.") and
                                   (recItem."Net Weight" <> 0)
                                then
                            ...
                            if "Sales Invoice Line".Type in ["Sales Invoice Line".Type::"G/L Account", "Sales Invoice Line".Type::Item] then
                                ReportEvent.GetEUArticle(
                                  ...
                                  "Sales Invoice Header"."EU 3-Party Trade",  // 10-06-22 ZY-LD 016
                                  ArticleText);
            ...
            begin
                ...
                if "Sales Invoice Header"."Bill-to Name" = "Sales Invoice Header"."Ship-to Name" then begin
                    "Sales Invoice Header"."Bill-to Name" := '';
                    "Sales Invoice Header"."Ship-to Name" := '';
                end else
                    "Sales Invoice Header"."Bill-to Name" := "Sales Invoice Header"."Ship-to Name";
                "Sales Invoice Header"."Bill-to Name 2" := "Sales Invoice Header"."Ship-to Name 2";
                if "Sales Invoice Header"."Bill-to Address" = "Sales Invoice Header"."Ship-to Address" then begin
                    "Sales Invoice Header"."Bill-to Address" := '';
                    "Sales Invoice Header"."Ship-to Address" := '';
                end else
                    "Sales Invoice Header"."Bill-to Address" := "Sales Invoice Header"."Ship-to Address";
                "Sales Invoice Header"."Bill-to Address 2" := "Sales Invoice Header"."Ship-to Address 2";
                "Sales Invoice Header"."Bill-to City" := "Sales Invoice Header"."Ship-to City";
                "Sales Invoice Header"."Bill-to Contact" := "Sales Invoice Header"."Ship-to Contact";
                "Sales Invoice Header"."Bill-to Post Code" := "Sales Invoice Header"."Ship-to Post Code";
                "Sales Invoice Header"."Bill-to County" := "Sales Invoice Header"."Ship-to County";
                "Sales Invoice Header"."Bill-to Country/Region Code" := "Sales Invoice Header"."Ship-to Country/Region Code";
                ...
                if "Sales Invoice Header"."Shipment Method Code" = '' then
                    ...
                    if not ShipmentMethod.Get("Sales Invoice Header"."Shipment Method Code") then
                        ShipmentMethod."Read Incoterms City From" := ShipmentMethod."read incoterms city from"::"Ship-to City";
                    //>> 11-12-20 ZY-LD 012
                ...
                if "Sales Invoice Header"."Bill-to Name" = "Sales Invoice Header"."Ship-to Name" then
                    "Sales Invoice Header"."Ship-to Name" := '';
                if "Sales Invoice Header"."Bill-to Address" = "Sales Invoice Header"."Ship-to Address" then
                    "Sales Invoice Header"."Ship-to Address" := '';
                ...
                if "Sales Invoice Header"."Ship-to VAT" <> '' then
                    SellVATID := "Sales Invoice Header"."Ship-to VAT"
                else  //<< 05-11-21 ZY-LD 014
                    SellVATID := ''; //sellcust."VAT Registration No.";  //RD001
                LineText[1] := '';
                LineText[2] := '';
                LineText[3] := '';
                LineText[4] := '';
                ...
                //>> 31-10-17 ZY-LD 001
                Clear(SellToCountryRegion);
                if "Sales Invoice Header"."Ship-to Country/Region Code" <> '' then
                    SellToCountryRegion.Get("Sales Invoice Header"."Ship-to Country/Region Code");
                //<< 31-10-17 ZY-LD 001
                ...
                */
                ...
                if not recCountry.Get(CompanyInfo."Bank Country/Region Code") then
                    Clear(recCountry);
    ...
    begin
        //>> 11-02-19 ZY-LD 002
        if BillToCountryRegion.Get("Sales Invoice Header"."Bill-to Country/Region Code") and BillToCountryRegion."Commercial Invoice" then
    ...
    procedure InitializeRequest2("¨": Boolean)
    begin
    end;
