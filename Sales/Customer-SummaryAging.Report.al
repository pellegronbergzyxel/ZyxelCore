report 50028 "Customer - Summary Aging ZX"
{
    DefaultLayout = RDLC;
    RDLCLayout = './Layouts/SalesReceivables/CustomerSummaryAging.rdlc';
    ...
    dataset
    {
        dataitem(Customer; Customer)
        {
            ...
            dataitem("Integer"; "Integer")
            {
                ...
                column(CustBalanceDue_6_Control22; CustBalanceDue[6])
                {
                    AutoFormatExpression = TempCurrency.Code;
                    AutoFormatType = 1;
                }
                ...
                begin
                    ...
                    //for i := 1 to 5 do begin  // 14-03-22 ZY-LD 001
                    for i := 1 to 6 do begin  // 14-03-22 ZY-LD 001
            ...
            begin
                ...
                //>> 14-03-22 ZY-LD 001
                if PrintCustomersOnly then
                    SetRange("Related Company", false);
                //<< 14-03-22 ZY-LD 001
    ...
    requestpage
    {
        ...
        layout
        {
            area(content)
            {
                ...
                {
                    Caption = 'Options';
                    field(StartingDate; PeriodStartDate[3])
                    {
                        ApplicationArea = Basic, Suite;
                    ...
                    field(OverDuePeriodLengthReq; OverDuePeriodLength)
                    {
                        ApplicationArea = Basic, Suite;
                        Caption = 'Over Due Period Length';
                    }
                    ...
                    field(PrintCustomersOnlyReq; PrintCustomersOnly)
                    {
                        ApplicationArea = Basic, Suite;
                        Caption = 'Show Customers Only';
                    }
                }
            }
        }
        ...
        begin
            ...
            //>> 14-03-22 ZY-LD 001
            if Format(OverDuePeriodLength) = '' then
                Evaluate(OverDuePeriodLength, '<-5D>');
            //<< 14-03-22 ZY-LD 001
    ...
    begin
        ...
        //>> 14-03-22 ZY-LD 001
        PeriodStartDate[2] := CalcDate(OverDuePeriodLength, PeriodStartDate[3]);
        for i := 4 to 6 do
    ...
    var
        ...
        PrintLine: Boolean;
        i: Integer;
        InCustBalanceDueLCY: array[6] of Decimal;
        InCustBalanceDueLCY2: array[6] of Decimal;
        ...
        OverDuePeriodLength: DateFormula;
        PrintCustomersOnly: Boolean;


    procedure InitializeRequest(StartingDate: Date; SetPeriodLength: Text[1024]; ShowAmountInLCY: Boolean)
    begin

        //PeriodStartDate[2] := StartingDate;;  // 14-03-22 ZY-LD 001
        PeriodStartDate[3] := StartingDate;  // 14-03-22 ZY-LD 001
