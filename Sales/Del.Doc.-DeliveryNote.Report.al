report 50186 "Del. Doc. - Delivery Note"
{
    // DD1.00 2021-09-15 Delta Design A/S
    //  - Object created
    // 001. 18-05-22 ZY-LD 2022011110000088 - Filtering on Freight Cost Item.
    DefaultLayout = RDLC;
    RDLCLayout = './Layouts/Del. Doc. - Delivery Note.rdlc';
    Caption = 'Delivery Document - Delivery Note';
        ...
        dataitem("VCK Delivery Document Header"; "VCK Delivery Document Header")
        {
            ...
            dataitem(CopyLoop; "Integer")
            {
                ...
                dataitem(PageLoop; "Integer")
                {
                    ...
                    column(PostingDate_SalesInvHdr; Format("VCK Delivery Document Header".PickDate, 0, '<Closing><Day>. <Month Text> <Year4>'))
                    {
                    }
                    ...
                    column(LineText9; LineText[9])
                    {
                    }
                    column(LineText10; LineText[10])
                    {
                    }
                    column(LineText11; LineText[11])
                    {
                    }
                    column(LineText12; LineText[12])
                    {
                    }
                    column(LineText13; LineText[13])
                    {
                    }
                    column(LineText14; LineText[14])
                    {
                    }
                    ...
                    column(ExternalDocumentNo; "VCK Delivery Document Line"."Shipper Reference")
                    {
                    }
                    ...
                    {
                        CalcFields = "Gross Weight", "Net Weight";
                        ...
                        column(GrossWeight; "VCK Delivery Document Line"."Gross Weight" * "VCK Delivery Document Line".Quantity)
                        {
                        }
                        column(NetWeight; "VCK Delivery Document Line"."Net Weight" * "VCK Delivery Document Line".Quantity)
                        {
                        }
                        column(CustomerOrderNoLine; "VCK Delivery Document Line"."Customer Order No.")
                        {
                        }
                        ...
                        begin
                            ...
                            LineText[2] := StrSubstNo(Text50007, TotalGrossWeight);
                            LineText[3] := StrSubstNo(Text50008, TotalNetWeight);

                            if recDelDocNote.Get("VCK Delivery Document Header"."No.") then begin
                                if recDelDocNote."Delivery Comment 1" <> '' then begin
                                    LineText[4] := '---';
                                    LineText[5] := recDelDocNote."Delivery Comment 1";
                                end;
                                if recDelDocNote."Delivery Comment 2" <> '' then
                                    LineText[6] := recDelDocNote."Delivery Comment 2";
                                if recDelDocNote."Delivery Comment 3" <> '' then
                                    LineText[7] := recDelDocNote."Delivery Comment 3";
                                if recDelDocNote."Delivery Comment 4" <> '' then
                                    LineText[8] := recDelDocNote."Delivery Comment 4";
                                if recDelDocNote."Delivery Comment 5" <> '' then
                                    LineText[9] := recDelDocNote."Delivery Comment 5";
                                if recDelDocNote."Delivery Comment 6" <> '' then
                                    LineText[10] := recDelDocNote."Delivery Comment 6";
                                if recDelDocNote."Delivery Comment 7" <> '' then
                                    LineText[11] := recDelDocNote."Delivery Comment 7";
                                if recDelDocNote."Delivery Comment 8" <> '' then
                                    LineText[12] := recDelDocNote."Delivery Comment 8";
                                if recDelDocNote."Delivery Comment 9" <> '' then
                                    LineText[13] := recDelDocNote."Delivery Comment 9";
                                if recDelDocNote."Delivery Comment 10" <> '' then
                                    LineText[14] := recDelDocNote."Delivery Comment 10";
                            end;
                        end;
                    ...
                    dataitem(EndOfDocument; "Integer")
                    {
                        DataItemTableView = where(Number = const(1));
                        column(PrintButtom; Format(PrintButtom))
                        {
                        }
            ...
            begin
                ...
                if "VCK Delivery Document Header"."Salesperson Code" = '' then begin
                    ...
                    SalesPurchPerson.Get("VCK Delivery Document Header"."Salesperson Code");
                ...
                FormatAddrExt.DeliveryInvSellTo(CustAddr, "VCK Delivery Document Header");
                  ...
                  CASE ShipmentMethod."Read Incoterms City From" OF
                    ShipmentMethod."Read Incoterms City From"::"Ship-to City" :
                      BEGIN
                        ...
                        ShipmentMethod.Description := STRSUBSTNO('%1 %2',"Shipment Method Code","Ship-to City");  // 09-07-20 ZY-LD 011
                      END;
                    ShipmentMethod."Read Incoterms City From"::"Location City" :
                      BEGIN
                        recLocation.GET("Location Code");
                        ShipmentMethod.Description := STRSUBSTNO('%1 %2',"Shipment Method Code",recLocation.City);
                      END;
                  END;
                  //<< 11-12-20 ZY-LD 012
                END;
                        ...
                        if recCountry."Shipment Method for Customs" <> '' then begin
                            ...
                            case ShipmentMethod."Read Incoterms City From" of
                                ShipmentMethod."read incoterms city from"::"Ship-to City":
                                    begin
                                        //ShipmentMethod.TranslateDescription(ShipmentMethod,"Language Code");
                                        //ShipmentMethod.Description := STRSUBSTNO('%1 %2',"Shipment Method Code","Ship-to City");
                                    end;
                                ShipmentMethod."read incoterms city from"::"Location City":
                                    begin
                                        //recLocation.GET("Location Code");
    ...
    var
        ...
        InvNoCaptionLbl: Label 'Delivery Note No.';
        ...
        PrintButtom: Boolean;
        recDelDocNote: Record "VCK Delivery Note Comments";
    ...
    begin
        CustomsInvoice := NewCustomsInvoice;
    end;
}
