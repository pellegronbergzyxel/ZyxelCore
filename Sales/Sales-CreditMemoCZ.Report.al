Report 50020 "Sales - Credit Memo CZ"
{
    ...
    dataset
    {
        dataitem("Sales Cr.Memo Header"; "Sales Cr.Memo Header")
        {
            ...
            column(SalesCrMemoHeaderVATBusPostingGroup; "Sales Cr.Memo Header"."VAT Bus. Posting Group")
            {
            }
            dataitem(CopyLoop; "Integer")
            {
                ...
                dataitem(PageLoop; "Integer")
                {
                    ...
                    column(SalesCrMemoHeaderCurrencyCode; "Sales Cr.Memo Header"."Currency Code")
                    {
                    }
                    ...
                    dataitem("Sales Cr.Memo Line"; "Sales Cr.Memo Line")
                    {
                        ...
                        column(DescriptionWeee_SalesCrLine; DescriptionWEEE)
                        {
                        }
                            ...
                            if ("Sales Cr.Memo Line".Type = "Sales Cr.Memo Line".Type::Item) and recItem.Get("Sales Cr.Memo Line"."No.") then begin
                                ...
                                if "Sales Cr.Memo Header"."Posting Date" >= 20210101D then begin
                                    ...
                                    if recCountry."Recycling Fee per. Unit" <> 0 then begin
                                        ...
                                        DescriptionWEEE :=
                                          StrSubstNo(zText001,
                                            Format(ROUND("Sales Cr.Memo Line".Quantity * recCountry."Recycling Fee per. Unit"), 0, '<Precision,2:2><Standard Format,3>'),
            ...
            begin
                ...
                if "Sales Cr.Memo Header"."Currency Factor" = 0 then
                    CZKexchr := 1 else
                    CZKexchr := 1 / "Sales Cr.Memo Header"."Currency Factor";
