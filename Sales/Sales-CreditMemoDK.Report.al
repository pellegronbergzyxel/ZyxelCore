Report 50021 "Sales - Credit Memo DK"
{
    // 001. 06-06-19 ZY-LD P0213 - New setup for VAT Registration No. Zyxel.
    // 002. 07-01-20 ZY-LD 2020010710000063 - Reorganized the Norvegan VAT calculation
    ...
    DefaultLayout = RDLC;
    RDLCLayout = './Layouts/Sales - Credit Memo DK.rdlc';
        ...
        dataitem("Sales Cr.Memo Header"; "Sales Cr.Memo Header")
        {
            ...
            dataitem(CopyLoop; "Integer")
            {
                ...
                dataitem(PageLoop; "Integer")
                {
                    ...
                    column(SalesCrMemoHeaderIntercompanyPurchase; "Sales Cr.Memo Header"."Intercompany Purchase")
                    {
                    }
                        ...
                        begin
                            ...
                            if "Sales Cr.Memo Line".Type in ["Sales Cr.Memo Line".Type::"G/L Account", "Sales Cr.Memo Line".Type::Item] then
                                ReportEvent.GetEUArticle(
                                  ...
                                  "Sales Cr.Memo Header"."EU 3-Party Trade",  // 10-06-22 ZY-LD 005
                                  ArticleText);
                    ...
                    dataitem(VATCounter; "Integer")
                    {
                        ...
                        begin
                            ...
                            //>> 07-01-20 ZY-LD 002
                            // recCurrency.SETFILTER("Currency Code",'NOK');
                            // IF recCurrency.FINDLAST THEN BEGIN
                            //  IF recCurrency."Relational Exch. Rate Amount" <> 0 THEN
                            //    NOKVAT := VATAmountLine."VAT Amount" / recCurrency."Relational Exch. Rate Amount" * recCurrency."Exchange Rate Amount";
                            // END;
                            ...
                            if ZGT.CompanyNameIs(10) then begin  //  ZyND DK
                                if "Sales Cr.Memo Header"."Intercompany Purchase" = 'IC-NO' then
                            ...
                            if CalculateCurrency then begin
                                ...
                                if CurrencyCode <> GLSetup."LCY Code" then begin
                                    ...
                                    recCurrency.SetFilter("Starting Date", '..%1', "Sales Cr.Memo Header"."Posting Date");
                                ...
                                NOKVAT := 0;  //VATAmountLine."VAT Amount";  // 18-10-19 ZY-LD 005
                            //<< 07-01-20 ZY-LD 002
                        end;
            ...
            begin
                ...
                if ("Sales Cr.Memo Header"."Intercompany Purchase" <> '') then begin
                    CompanyInfo.ChangeCompany('ZyND NO');
                    CompanyInfo.Get;
                end;
