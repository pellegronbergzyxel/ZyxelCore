report 50024 "Statement ZX"
{
    // 001. 24-05-18 2018052410000215 - Change to "Finance Phone No." and "Finance E-mail".
    // 002. 28-08-18 ZY-LD 2018060810000271 - Finance has decided to run statement as default.
    // 003. 16-08-18 ZY-LD 2018101610000042 - Now finance has decided not to show open entries.
    // 003. 25-10-18 ZY-LD 2018101610000042 - If Show only open entries, we find the date for the first open entry as startdate.

    DefaultLayout = RDLC;
    RDLCLayout = './Layouts/SalesReceivables/Statement.rdlc';
    Caption = 'Statement';
    ...
    dataset
    {
        dataitem(Customer; Customer)
        {
            ...
            var
                CustLedgerEntry: Record "Cust. Ledger Entry";
            begin
                StartDate := DefaultStartDate;  // 25-10-18 ZY-LD 003
    ...
    requestpage
    {
        ...
        layout
        {
            area(content)
            {
                ...
                {
                    Caption = 'Options';
                    field("Start Date"; DefaultStartDate)
                    {
                    ...
                    field(RiBaDueDateReq; RiBaDueDate)
                    {
                        ApplicationArea = Basic, Suite;
                        Caption = 'Ri.Ba. Due Date';
                        Visible = false;
                    }
                    ...
                    field(PrintOnlyOpenEntriesReq; PrintOnlyOpenEntries)
                    {
                        ApplicationArea = Basic, Suite;
