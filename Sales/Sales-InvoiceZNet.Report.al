report 50000 "Sales - Invoice ZNet"
{
    ...
    DefaultLayout = RDLC;
    RDLCLayout = './Layouts/Sales - Invoice ZNet.rdlc';
        ...
        dataitem("Sales Invoice Header"; "Sales Invoice Header")
        {
            ...
            dataitem(CopyLoop; "Integer")
            {
                ...
                dataitem(PageLoop; "Integer")
                {
                    ...
                    column(eCommerceOrder; "Sales Invoice Header"."eCommerce Order")
                    {
                    }
            ...
            begin
                ...
                if not "Sales Invoice Header"."eCommerce Order" then begin
                    /*
                ...
                if recCountry.Get(CompanyInfo."Bank Country/Region Code") then;
