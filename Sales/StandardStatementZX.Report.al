report 50062 "Standard Statement Zyxel"
{
    //RDLCLayout = './SalesReceivables/StandardStatement.rdlc';
    //WordLayout = './StandardStatement.docx';
    RDLCLayout = './Layouts/SalesReceivables/StandardStatementZX.rdlc';
    WordLayout = './Layouts/SalesReceivables/StandardStatementZX.docx';
    ...
    dataset
    {
        dataitem(Customer; Customer)
        {
            ...
            dataitem("Integer"; "Integer")
            {
                ...
                column(PhoneNo_CompanyInfo; CompanyInfo."Finance Phone No.")
                {
                }
                ...
                column(CompanyInfoEmail; CompanyInfo."Finance E-Mail")
                {
                }
                    ...
                    dataitem(CustLedgEntryHdr; "Integer")
                    {
                        ...
                        dataitem(DtldCustLedgEntries; "Detailed Cust. Ledg. Entry")
                        {
                            ...
                            begin
                                ...
                                //>> 06-03-24 ZY-LD 001
                                IF PrintOnlyOpenEntries AND (RemainingAmount = 0) THEN
                                    CurrReport.SKIP;
                                //<< 06-03-24 ZY-LD 001
                                ...
                                if PrintLine then begin
                                    ...
                                    //>> 06-03-24 ZY-LD 001
                                    IF PrintOnlyOpenEntries THEN
                                        CustBalance := CustBalance + RemainingAmount
                                    ELSE  //<< 06-03-24 ZY-LD 001
            ...
            trigger OnAfterGetRecord()
            var
                recCustLedgerEntry: Record "Cust. Ledger Entry";  // 06-03-24 ZY-LD 001

            begin
                TempAgingBandBuf.DeleteAll();
                CurrReport.Language := LanguageZX.GetLanguageIdOrDefault("Language Code");
                ...
                IF PrintOnlyOpenEntries THEN BEGIN
                    ...
                    IF recCustLedgerEntry.FINDFIRST THEN
                        StartDate := CALCDATE('<-CW>', recCustLedgerEntry."Posting Date");
                END;
                //<< 06-03-24 ZY-LD 001
            ...
            trigger OnPreDataItem()
            begin
                StartDate := DefaultStartDate;  // 06-03-24 ZY-LD 001
    ...
    requestpage
    {
        ...
        layout
        {
            area(content)
            {
                ...
                {
                    Caption = 'Options';
                    //field("Start Date"; StartDate)  // 06-03-24 ZY-LD 001
                    field("Start Date"; DefaultStartDate)  // 06-03-24 ZY-LD 001
                    {
                    ...
                    //>> 06-03-24 ZY-LD 001
                    field(PrintOnlyOpenEntries; PrintOnlyOpenEntries)
                    {
                        ApplicationArea = Basic, Suite;
                        Caption = 'Show only Open Entries';
                        ToolTip = 'Specifies if you want to show open entries only on the statement.';
                    }
                    //<< 06-03-24 ZY-LD 001
                    group(Include)
                    {
    ...
    var
        ...
        PrintOnlyOpenEntries: Boolean;  // 06-03-24 ZY-LD 001
        DueDate: Date;
        DefaultStartDate: Date;  // 06-03-24 ZY-LD 001
        ...
        ClosingLbl: Label 'Kind regards';
        BodyLbl: Label 'Thank you for your business. Your statement is attached to this message.';
        BodyLblZX: Label 'Please, find attached our latest statement of your customer account with %1 as of %2. Kindly check if all included documents are correct and registered on your end. In case of any questions or differences do not hesitate to contact us back at %3.';
    ...
    begin
        ...
        EndDate := NewEndDate;
        PrintOnlyOpenEntries := NewPrintOnlyOpenEntries;  // 06-03-24 ZY-LD 001
    end;
    ...
    local procedure SetupBodyText()
    var
        Email: Text;
    Begin
        if CompanyInfo."Finance E-Mail" <> '' then
            email := CompanyInfo."Finance E-Mail"
        else
            Email := CompanyInfo."E-Mail";
        BodyTextZX := StrSubstNo(BodyLblZX, CompanyInfo.Name, Format(EndDate, 0, 4), Email);
    End;
