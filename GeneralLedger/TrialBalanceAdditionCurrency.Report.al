report 50068 "Trial Balance Add. Currency"
{
    DefaultLayout = RDLC;
    RDLCLayout = '.\Layouts\Trial Balance Additional Currency.rdlc';
    AdditionalSearchTerms = 'year closing,close accounting period,close fiscal year';
    ApplicationArea = Basic, Suite;
    Caption = 'Trial Balance Additional Currency';
    ...
    dataset
    {
        dataitem("G/L Account"; "G/L Account")
        {
            ...
            dataitem("Integer"; "Integer")
            {
                ...
                column(G_L_Account___Net_Change_; "G/L Account"."Additional-Currency Net Change")
                {
                }
                column(G_L_Account___Net_Change__Control22; -"G/L Account"."Additional-Currency Net Change")
                {
                    AutoFormatType = 1;
                }
                column(G_L_Account___Balance_at_Date_; "G/L Account"."Add.-Currency Balance at Date")
                {
                }
                column(G_L_Account___Balance_at_Date__Control24; -"G/L Account"."Add.-Currency Balance at Date")
                {
                    AutoFormatType = 1;
                }
    ...
    var
        ...
        Trial_BalanceCaptionLbl: Label 'Trial Balance - Addtional Reporting Currency';
