...
report 50064 "Intrastat Report Get Lines ZX"
#pragma warning restore N0301
{
    ...
    //     CompanyInfo."Country/Region Code" := CompanyInfo."Ship-to Country/Region Code";  // 14-10-22 ZY-LD 001
    ...
    // var
    //     Location: Record Location;  // ZY-LD 
    //     IsHandled: Boolean;
    // begin
    ...
    //         IntrastatReportLine."Opposite Country/Region Code" := GetShipFromLocation("Item Ledger Entry"."External Document No.")
    //     ELSE
    //         IntrastatReportLine."Opposite Country/Region Code" := CompanyInfo."Country/Region Code";
    //     //<< 14-10-22 ZY-LD 001
    ...
    //                         Location."Country/Region Code" := GetShipFromLocation("Item Ledger Entry"."External Document No.");
    ...
    // var
    //     AmzOrderArch: Record "eCommerce Order Archive";
    // begin
    //     AmzOrderArch.SETRANGE("eCommerce Order Id", pExtDocNo);
    //     AmzOrderArch.FINDFIRST;
    //     EXIT(AmzOrderArch."Ship-from Country");
    // end;
}