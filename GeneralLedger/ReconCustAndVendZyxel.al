...
report 50109 "Recon Cust. and Vend. Zyxel"
{   //04-12-2025 BK #542622
    DefaultLayout = RDLC;
    RDLCLayout = './Layouts/ReconcileCustandVendAccsZ.rdlc';
    ApplicationArea = Basic, Suite;
    Caption = 'Reconcile Customer and Vendor Accounts Zyxel';
                    ...
                    case true of
                        ...
                        (ReconCustVendBuffer."Field No." = CustPostingGr.FieldNo("Receivables Account")):
                            begin
                                ...
                                Amount := CalcCustAccAmount1(ReconCustVendBuffer."Posting Group");
                            end;
                        (ReconCustVendBuffer."Table ID" = DATABASE::"Customer Posting Group") and
                        ...
                        (ReconCustVendBuffer."Field No." = VendPostingGr.FieldNo("Payables Account")):
                            begin
                                ...
                                Amount := CalcVendAccAmount1(ReconCustVendBuffer."Posting Group");
                            end;
                        (ReconCustVendBuffer."Table ID" = DATABASE::"Vendor Posting Group") and
    ...
    local procedure CalcCustAccAmount1(PostingGr: Code[20]): Decimal
    var
    ...
    local procedure CalcVendAccAmount1(PostingGr: Code[20]): Decimal
    var
        Vend: Record Vendor;
        DtldVendLedgEntry: Record "Detailed Vendor Ledg. Entry";
